/**
 * @brief: key button, request_irq with driver -- irq content in timer handler; -- porting on 29/6/2025
 *
 * @chapter: Notion -- 
 ...
 * 		3. insmod .ko
 * 		4. 按下开发板上的 key1, key2
 * 		5. 我此例子中，没有执行测试程序，只按了按键;
 *			output:
 *				[  481.858333] gpio_key_irq_zlj key 189 val 0 irq happened
 *				[  481.884401] key_timer_expire gpio 110 val 1
 *				[  482.035336] gpio_key_irq_zlj key 189 val 1 irq happened
 *				[  482.064447] key_timer_expire gpio 110 val 0
 *
 *				还有个疑问：为什么同一次中断，获得的按键值不一样？
