/**
 * @brief: GPIO: LED driver; LED glitters by waved-like time interval; -- platfrom_driver && platform_device -- 2/4/2025
 *
 * @steps:
 *      1. 驱动的 总线-设备-驱动 分离模型进行，可以完全参考git:
 *      	kerneltravel/Courses/Embedded_Linux_application_development/writing_APP_to_operate_hardware/first_drv/hello_drv_v2
